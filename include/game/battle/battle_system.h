...
class BattleSystem {
  public:
    BattleSystem(entt::dispatcher& dispatcher,
    ...
    [[nodiscard]] const CombatContext& getContext()  const noexcept { return m_ctx; }
    [[nodiscard]] entt::registry&      getRegistry() noexcept       { return m_reg; }
    [[nodiscard]] entt::entity         getPlayer()   const noexcept { return m_player; }
    [[nodiscard]] const CardDatabase&  getCardDb()   const noexcept { return m_card_db; }
